...
from forms.modulisForma import ModulisForma, PaskaitaForma
    ...
    def create():
        ...
        if form.validate_on_submit():
            # try:
                ...
                atsiskaitymas_data_list = [
                    {
                        'pavadinimas': atsiskaitymas.pavadinimas.data,
                        'date': atsiskaitymas.date.data,
                        # 'laikas_nuo': atsiskaitymas.laikas_nuo.data,
                        # 'laikas_iki': atsiskaitymas.laikas_iki.data
                ...
                mo_act.sukurti_moduli(
                    ...
                    atsiskaitymas_data_list=atsiskaitymas_data_list
                )
    ...
    def update(id):
        ...
        if request.method == 'GET':
            ...
            for paskaita in modulis.paskaitos:
                form.paskaitos.append_entry(paskaita)

            # for atsiskaitymas in modulis.atsiskaitymai:
            #     form.atsiskaitymai.append_entry(atsiskaitymas)
